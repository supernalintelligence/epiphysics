...
- **$\mathcal{T}$, $P$, $S_{\text{ent}}$, $\mathcal{F}$** (C): thermodynamic quantities emerge from many-entity ensembles; temperature $\mathcal{T} \propto \langle K \rangle$ is the *equipartition* definition, valid at equilibrium - many social systems are far from equilibrium, requiring non-equilibrium extensions
...
| $\mathcal{T} \propto \langle K \rangle$ | P | Temperature: equipartition definition; requires near-equilibrium; many systems are far from equilibrium |
